...
export default function MaterialClient({ bloque, nodos = [], quizPreguntas = [], recursos = [], slug }) {
  ...
  if (!bloque) {
    return (
      <div style={{ minHeight: '100vh', background: colors.bg, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: '16px' }}>
        <p style={{ color: colors.text, fontSize: '16px' }}>Bloque no encontrado.</p>
    ...
    <div style={{ minHeight: '100vh', background: colors.bg, color: colors.text, paddingBottom: '80px' }}>
      ...
      <div style={{
        ...
        <div style={{ gridColumn: isMobile ? '1' : '2' }}>
          ...
          {/* Breadcrumb */}
          <nav style={{ maxWidth: '880px', margin: '0 auto', padding: isMobile ? '8px 24px 0' : isTablet ? '8px 32px 0' : '8px 40px 0 48px', width: '100%' }}>
